const CACHE_NAME='kubochan-pan-v3.3.0';
const ASSETS=['./','index.html?v=3.3.0','style.css?v=3.3.0','storage.js?v=3.3.0','app.js?v=3.3.0','manifest.json?v=3.3.0','icon-192.png','icon-512.png'];
