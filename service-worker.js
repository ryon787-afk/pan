const CACHE_NAME='kubochan-pan-v3.3.1';
const ASSETS=['./','index.html?v=3.3.1','style.css?v=3.3.1','storage.js?v=3.3.1','app.js?v=3.3.1','manifest.json?v=3.3.1','icon-192.png','icon-512.png'];
