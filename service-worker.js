const CACHE_NAME='kubochan-pan-v3.3.7';
const ASSETS=['./','index.html?v=3.3.7','style.css?v=3.3.7','storage.js?v=3.3.7','app.js?v=3.3.7','manifest.json?v=3.3.7','icon-192.png','icon-512.png'];
