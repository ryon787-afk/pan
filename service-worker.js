const CACHE_NAME='kubochan-pan-v3.3.2';
const ASSETS=['./','index.html?v=3.3.2','style.css?v=3.3.2','storage.js?v=3.3.2','app.js?v=3.3.2','manifest.json?v=3.3.2','icon-192.png','icon-512.png'];
