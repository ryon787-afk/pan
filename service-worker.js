const CACHE_NAME='kubochan-pan-v3.3.6';
const ASSETS=['./','index.html?v=3.3.6','style.css?v=3.3.6','storage.js?v=3.3.6','app.js?v=3.3.6','manifest.json?v=3.3.6','icon-192.png','icon-512.png'];
